		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑活动项目</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑活动项目</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">活动项目信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>活动</label>
										<input id="huodong" name="huodong" class="form-control" placeholder="活动">
									</div>
									<div class="form-group col-md-6">
										<label>类型</label>
									...
									<div class="form-group col-md-6">
										<label>集合点</label>
										<input id="jihedian" name="jihedian" class="form-control" placeholder="集合点">
									</div>
									<div class="form-group col-md-6">
										<label>时间</label>
									...
									<div class="form-group col-md-6">
										<label>地点</label>
										<input id="didian" name="didian" class="form-control" placeholder="地点">
									</div>
									<div class="form-group col-md-6">
										<label>费用</label>
										<input id="feiyong" name="feiyong" class="form-control" placeholder="费用">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "huodongxiangmu/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("huodongxiangmu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("huodongxiangmu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#jihedian").val(ruleForm.jihedian);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.huodong != null && res.data.huodong != ''){

					$("#huodong").val(res.data.huodong);
					}
					...
					if(res.data != null && res.data != '' && res.data.jihedian != null && res.data.jihedian != ''){

					$("#jihedian").val(res.data.jihedian);
					}
					...
					if(res.data != null && res.data != '' && res.data.didian != null && res.data.didian != ''){

					$("#didian").val(res.data.didian);
					}
