      ...
      <form class="layui-form" style="margin: 10px 0;">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="mubiao" id="mubiao" placeholder="目标" autocomplete="off" class="layui-input">
          </div>
        </div>   
        <div class="layui-inline">
        ...
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('mubiaozhiding','新增')" @click="jump('../mubiaozhiding/add.jsp')" type="button" class="layui-btn btn-theme">
      ...
      <div class="box">
        <ul class="clearfix">
          <li v-for="(item,index) in dataList" v-bind:key="index">
            <a :href="'../mubiaozhiding/detail.jsp?id='+item.id">
              <figure>
              </figure>
              <div class="div1">
                <b></b>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#mubiao').val()) {
          param['mubiao'] = jquery('#mubiao').val() ? '%' + jquery('#mubiao').val() + '%' : '';
        }  
        ...
        // 获取列表数据
        http.request('mubiaozhiding/list', 'get', param, function(res) {
