...
public class ZaixianxuexiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		zaixianxuexi.setClicktime(new Date());
    ...
    public R autoSort(@RequestParam Map<String, Object> params,ZaixianxuexiEntity zaixianxuexi, HttpServletRequest request,String pre){
        EntityWrapper<ZaixianxuexiEntity> ew = new EntityWrapper<ZaixianxuexiEntity>();
