...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>在线学习管理</span></li>
								<li class="breadcrumb-item active"><span>在线学习列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="zhishiSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										类型
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('zhishi')">知识<i id="zhishiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#zhishiSearch').val() != null && $('#zhishiSearch').val() != ''){
				searchForm.zhishi ="%" +  $('#zhishiSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var zhishiCell  = document.createElement('td');

						 zhishiCell.innerHTML = item.zhishi;


			row.appendChild(zhishiCell);
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"zaixianxuexi");
