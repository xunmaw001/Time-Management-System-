      ...
      <form class="layui-form" style="margin: 10px 0;">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="zhishi" id="zhishi" placeholder="知识" autocomplete="off" class="layui-input">
          </div>
        </div>   
        <div class="layui-inline">
        ...
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('zaixianxuexi','新增')" @click="jump('../zaixianxuexi/add.jsp')" type="button" class="layui-btn btn-theme">
      ...
      <div class="box">
        <ul class="clearfix">
          <li v-for="(item,index) in dataList" v-bind:key="index">
            <a :href="'../zaixianxuexi/detail.jsp?id='+item.id">
              <figure>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#zhishi').val()) {
          param['zhishi'] = jquery('#zhishi').val() ? '%' + jquery('#zhishi').val() + '%' : '';
        }  
