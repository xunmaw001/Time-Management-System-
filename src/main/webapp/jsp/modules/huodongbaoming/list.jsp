...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yingfujine')">应付金额<i id="yingfujineIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yingfujineCell  = document.createElement('td');

						 yingfujineCell.innerHTML = item.yingfujine;


			row.appendChild(yingfujineCell);
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"huodongbaoming");
